...
public class ColourGenerator
{
    ...
    public void UpdateSettings(ColourSettings settings)
    {
        ...
        int length = settings.biomeColourSettings.biomes.Length;
        if (texture == null || texture.height != length)
        {
            texture = new Texture2D(textureResolution * 2, length, TextureFormat.RGBA32, false);
        }
